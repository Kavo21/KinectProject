...
{
    /// <summary>
    /// PeerStudentsStoryMarking.xaml 的互動邏輯
    /// </summary>
    public partial class PeerStudentsStoryMarking : Window
    {
        ...
        /// 打開句子類別選單
        /// </summary>
        private SelectPeerStudentsStoryMarkingView selectPeerStudentsStoryMarking = new SelectPeerStudentsStoryMarkingView();
        ...
        public PeerStudentsStoryMarking()
        {
            InitializeComponent();
        ...
        {
            //打開句子類別選單
            selectPeerStudentsStoryMarking.Show();

            //註冊事件觸發後的方法
            selectPeerStudentsStoryMarking.SelectEvent += Select_Item_View_SelectEvent;
                    ...
                    case (int)BasicMethod.TriggerButtonCode.ExamplePosture:
                        ...
                        else
                        {
                            ...
                            if (TaskWords.Count > 0)
                            {
                                ...
                                exampleImage.Source = vocabulary.QueryImage(TaskWords[new Random().Next(0, TaskWords.Count)]);
                            }
                        }
                        break;
        ...
        {
            exampleImage.Visibility = Visibility.Hidden;
            ...
            //判斷是否顯示範例圖片
            if (Select_Item.SetPeerSentenceGameMode != true && Select_Item.SetPeerStudentsSentenceGameMode !=true)
            {
            ...
            //檢查句子是否包含單字方法
            CompareWords(txtVocabulary.Text);
        ...
        private void CompareWords(String Sentence)
        {
            ...
            //顯示句子中有幾個資料庫包含的單字
            txtCountWords.Content = "Target : "+TaskWords.Count.ToString();
        ...
        private void ShowSentence()
        {
            ...
            //為了系統截圖 句子中文翻譯
            txtCountWords.Content = "Chinese Translation";
